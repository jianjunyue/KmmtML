...
submission.to_csv('data/XGBClassifier.csv',index=None)
...
submission["Survived"]=y_pred
submission.to_csv('data/RandomForestClassifier.csv',index=None)
# accuracy_score=metrics.accuracy_score(y_pred,y_test)
...
submission["Survived"]=y_pred
submission.to_csv('data/GradientBoostingClassifier.csv',index=None)
# accuracy_score=metrics.accuracy_score(y_pred,y_test)
...
submission["Survived"]=y_pred
submission.to_csv('data/Stack.csv',index=None)
# accuracy_score=metrics.accuracy_score(y_pred,y_test)
...
submission["Survived"]=y_pred
submission.to_csv('data/Blend.csv',index=None)
# accuracy_score=metrics.accuracy_score(y_pred,y_test)
